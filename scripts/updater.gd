...
func _on_button_pressed():
	...
	square = Game.PlayerSquare.new(_tc, tiles, game.player_sq_node, game.square_start_pos, 0)
	triangle = Game.PlayerTriangle.new(_tc, tiles, game.player_tri_node, game.triangle_start_pos, 0)

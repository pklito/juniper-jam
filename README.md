...
Elaborated: 
- Instead of using full audio clips, I found single note WAV files, wrote my own sheet music and had it sync up to the characters movement in the game.
- This is a typical puzzle game, where there are many levels with shared assets, and you go into one once you finish the previous.
- I didn't do this optimally by any means, but it's a simple solution you could copy for your own game jams.
